...
- (void)CreatelineView {
    if (!_lineView) {
        ...
        _lineView.backgroundColor = [UIColor colorWithRed:0.25 green:0.51 blue:0.97 alpha:1.000];
    }
}
...
- (void)btnClick:(UIButton *)sender {
    ...
    [UIView animateWithDuration:0.1 animations:^{
        ...
        [sender setTitleColor:[UIColor colorWithRed:0.25 green:0.51 blue:0.97 alpha:1.000] forState:UIControlStateNormal];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if (_seletedBtn != btn) {
        [UIView animateWithDuration:0.1 animations:^{
            [btn setTitleColor:[UIColor colorWithRed:0.25 green:0.51 blue:0.97 alpha:1.000] forState:UIControlStateNormal];
            [_seletedBtn setTitleColor:[UIColor colorWithRed:0.276 green:0.274 blue:0.277 alpha:1.000] forState:UIControlStateNormal];
