...
MODE 2. >>>>>>>>>>>>>>> You can also use it in this way that is more brevity:
    ...
    Demo.bb_layout.topSpaceToView(v1, 100).bottomSpaceToView(v3, 100).leftSpaceToView(v0, 150).rightSpaceToView(v2, 150);
...
//#define BBAutoLayoutIssueLog

#import <UIKit/UIKit.h>

@class BBAutoLayoutModel;

typedef BBAutoLayoutModel *(^MarginToView)(UIView *toView, CGFloat value);
typedef BBAutoLayoutModel *(^Margin)(CGFloat value);
typedef BBAutoLayoutModel *(^MarginEqualToView)(UIView *toView);
typedef BBAutoLayoutModel *(^WidthHeight)(CGFloat value);
typedef BBAutoLayoutModel *(^WidthHeightEqualToView)(UIView *toView, CGFloat ratioValue);

@interface BBAutoLayoutModel : NSObject
...
@interface UIView (BBChangeFrameCore)
