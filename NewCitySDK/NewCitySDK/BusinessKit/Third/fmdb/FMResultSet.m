...
- (NSDate*)dateForColumnIndex:(int)columnIdx {
    ...
    return [_parentDB hasDateFormatter] ? [_parentDB
                                           ...
                                           dateFromString:[self stringForColumnIndex:columnIdx]] : [NSDate dateWithTimeIntervalSince1970:[self doubleForColumnIndex:columnIdx]];
}
